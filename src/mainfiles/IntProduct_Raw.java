...
public class IntProduct_Raw extends javax.swing.JFrame {

    public IntProduct_Raw() {
        initComponents();
        Connect();
        Fetch();
        LoadItemNo();
    ...
    public void LoadItemNo(){
        try {
            pst = con.prepareStatement("SELECT P_Num FROM tblraw");
            rs = pst.executeQuery();
            ...
            Logger.getLogger(IntProduct_Raw.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void Connect(){
        try {
            ...
            Logger.getLogger(IntProduct_Raw.class.getName()).log(Level.SEVERE, null, ex);
             ...
             Logger.getLogger(IntProduct_Raw.class.getName()).log(Level.SEVERE, "SQL Error: ", ex);
        }
    }
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
       IntProduct_NonRaw intnonraw = new IntProduct_NonRaw();
       intnonraw.setVisible(true);
       this.dispose();
    ...
    private void jPanel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel10MouseClicked
        try {
            ...
            JOptionPane.showMessageDialog(this, "P_Name and P_unit cannot be numeric values!");
            return;  // Exit the method, preventing the database insert
            }

        // Check if Quantity, Cost per Quantity, and Total Cost are numeric
             if (!isNumeric(itemquant) || !isNumeric(itemcpq) || !isNumeric(itemtc)) {
            JOptionPane.showMessageDialog(this, "P_Quantity, P_CostPerQuantity, and P_TotalCost must be numeric values!");
            return;  // Exit the method, preventing the database insert
            }
            ...
            pst = con.prepareStatement("INSERT INTO tblraw(P_Name, P_Quantity, P_Unit, P_CostPerQuantity, P_TotalCost, P_DateofPurchase, P_ExpirationDate)VALUES(?, ?, ?, ?, ?, ?,?)");
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        try {
            ...
            pst = con.prepareStatement("UPDATE tblraw SET P_Name = ? , P_Quantity = ?, P_Unit = ?, P_CostPerQuantity = ?, P_TotalCost = ?, P_DateofPurchase = ?, P_ExpirationDate = ? WHERE P_Num = ?");
    ...
    private void searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchMouseClicked
        try {
            ...
            pst = con.prepareStatement("SELECT * FROM tblraw WHERE P_Num = ?");
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        try {
            String ItemN = cbnum.getSelectedItem().toString();
            pst = con.prepareStatement("DELETE FROM tblraw WHERE P_Num = ?");
            pst.setString(1, ItemN);
            ...
            String countSQL = "SELECT COUNT(*) FROM tblraw";
            ...
            if (rowCount == 0) {
                String resetAutoIncrementSQL = "ALTER TABLE tblraw AUTO_INCREMENT = 1";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntProduct_Raw.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntProduct_Raw().setVisible(true);
            }
        });
    }
