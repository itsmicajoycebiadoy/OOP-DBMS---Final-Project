...
public class ExpDate_Raw extends javax.swing.JFrame {
    ...
    public void Connect(){
        try {
            ...
            Logger.getLogger(ExpDate_Raw.class.getName()).log(Level.SEVERE, null, ex);
             ...
             Logger.getLogger(ExpDate_Raw.class.getName()).log(Level.SEVERE, "SQL Error: ", ex);
        }
  ...
  private void Fetch() {
    try {
        ...
        while (rs.next()) {
            ...
            if ("Expired".equals(expirationStatus) || "Expiring Soon".equals(expirationStatus)) {
                tblraw.setRowSelectionInterval(rowIndex, rowIndex); 
            }
        }

      
        tblraw.setDefaultRenderer(Object.class, new CustomRenderer());
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
       ExpDate_NonRaw expnonraw = new ExpDate_NonRaw();
       expnonraw.setVisible(true);
       this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpDate_Raw.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExpDate_Raw().setVisible(true);
            }
        });
    }
