...
public class IntProduct_Main extends javax.swing.JFrame {

    /**
     * Creates new form IntProduct_Main
     */
    public IntProduct_Main() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntProduct_Main.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntProduct_Main().setVisible(true);
            }
        });
    }
